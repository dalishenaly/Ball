...
- (void)addCornerWithRectCorner:(UIRectCorner)rectCorner cornerSize:(CGSize)cornerSize {
    UIBezierPath *bezierPath = [UIBezierPath bezierPathWithRoundedRect:self.bounds byRoundingCorners:rectCorner cornerRadii:cornerSize];
