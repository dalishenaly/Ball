...
class THMyCollectVC: THBaseVC {
    ...
    func requestData(completion: (()->Void)?) {
        ...
        let param = ["page": page]
        THMineRequestManager.requestMyCollectionData(param: param, successBlock: { (result) in
...
extension THMyCollectVC: THCollectionViewFlowLayoutDelegate {
...
extension THMyCollectVC: UICollectionViewDelegate, UICollectionViewDataSource {
