...
class THFindRequestManager: NSObject {
    ...
    /// 请求视频详情页数据
    static func requestVideoCommentList(param:[String: Any], successBlock: @escaping successHandler, errorBlock: @escaping errorHandler) {
        
        THBaseNetworkManager.shared(subUrl: "/api/home/getCommentList")
            .getRequest(params: param, successBlock: successBlock, errorBlock: errorBlock)
    }
    ...
    /// 点赞
    static func requestVideoPraise(param:[String: Any], successBlock: @escaping successHandler, errorBlock: @escaping errorHandler) {
