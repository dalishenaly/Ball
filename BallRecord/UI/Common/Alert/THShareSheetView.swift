...
class THShareSheetView: UIView {
    ...
    static func showAlert(title: String, shareUrl: String) {
    ...
    @objc func clickWeChatView() {
        ...
        params.ssdkSetupShareParams(byText: shareText, images: UIImage(named: "AppIcon"), url: URL(string: self.shareUrl ?? ""), title: self.title ?? "精彩瞬间", type: .auto)
